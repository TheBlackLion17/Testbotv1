...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8341147081').split()]
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Pratik:Pratik@pratik.8bbpkoi.mongodb.net/?retryWrites=true&w=majority&appName=Pratik")
DATABASE_NAME = environ.get('DATABASE_NAME', "pratik")
...
# url shortner
SHORT_URL = environ.get("arolinks.com")
SHORT_API = environ.get("f869a7481f8b09f8b931f623338181f3f2116ec9")

# Others
IMDB_DELET_TIME = int(environ.get('IMDB_DELET_TIME', "300"))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '@Onlyforfreeadule_bot')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003647191644')).split()]
